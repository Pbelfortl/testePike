...
export function Menu() {
    ...
    return (
        ...
        <div className={`z-10 fixed right-0 top-0 flex box-border justify-center shadow-lg items-center bg-white transition-all duration-300 ease-in
        ${isMenuOpen ? 'w-screen h-screen' : 'rounded-bl-full w-[90px] h-[90px]'}`}>
